...
_STATION_MAP_BASE: dict[str, StationMeta] = {
    ...
    "houston": _station(
        "houston",
        "KHOU",
        "William P. Hobby Airport Station",
        29.6458,
        -95.2821,
        "America/Chicago",
        13,
    ...
    "kuala lumpur": _station(
        "kuala lumpur",
        "WMKK",
        "Kuala Lumpur Intl Airport Station",
        2.7470,
        101.7140,
        "Asia/Kuala_Lumpur",
        21,
    ...
    "lucknow": _station(
        "lucknow",
        "VILK",
        "Chaudhary Charan Singh Intl Airport Station",
        26.7610,
        80.8890,
        "Asia/Kolkata",
        121,
    ...
    "mexico city": _station(
        "mexico city",
        "MMMX",
        "Benito Juarez International Airport Station",
        19.4360,
        -99.0720,
        "America/Mexico_City",
        2224,
    ...
    "sao paulo": _station(
        "sao paulo",
        "SBGR",
        "Sao Paulo-Guarulhos International Airport Station",
        -23.4320,
        -46.4690,
        "America/Sao_Paulo",
        745,
...
_RULE_EVIDENCE: dict[str, dict[str, str]] = {
    ...
    "austin": _rule(
        "https://polymarket.com/event/highest-temperature-in-austin-on-june-19-2026",
        "highest temperature recorded at the Austin-Bergstrom International Airport Station",
    ),
    "beijing": _rule(
    ...
    "denver": _rule(
        "https://polymarket.com/event/highest-temperature-in-denver-on-june-19-2026",
        "highest temperature recorded at the Buckley Space Force Base Station",
    ),
    "guangzhou": _rule(
    ...
    "houston": _rule(
        "https://polymarket.com/event/highest-temperature-in-houston-on-june-19-2026",
        "highest temperature recorded at the William P. Hobby Airport Station",
    ),
    "istanbul": _rule(
    ...
    "kuala lumpur": _rule(
        "https://polymarket.com/event/highest-temperature-in-kuala-lumpur-on-june-19-2026",
        "highest temperature recorded at the Kuala Lumpur Intl Airport Station",
    ),
    "london": _rule(
    ...
    "lucknow": _rule(
        "https://polymarket.com/event/highest-temperature-in-lucknow-on-june-19-2026",
        "highest temperature recorded at the Chaudhary Charan Singh Intl Airport Station",
    ),
    "los angeles": _rule(
    ...
    "mexico city": _rule(
        "https://polymarket.com/event/highest-temperature-in-mexico-city-on-june-19-2026",
        "highest temperature recorded at the Benito Juarez International Airport Station",
    ),
    "miami": _rule(
    ...
    "san francisco": _rule(
        "https://polymarket.com/event/highest-temperature-in-san-francisco-on-june-19-2026",
        "highest temperature recorded at the San Francisco International Airport Station",
    ),
    "sao paulo": _rule(
        "https://polymarket.com/event/highest-temperature-in-sao-paulo-on-june-19-2026",
        "highest temperature recorded at the Sao Paulo-Guarulhos International Airport Station",
    ),
    "seattle": _rule(
